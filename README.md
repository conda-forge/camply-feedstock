...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/camply-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12923&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/camply-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `camply` can be installed with:

```
conda install camply
```

It is possible to list all of the versions of `camply` available on your platform with:
